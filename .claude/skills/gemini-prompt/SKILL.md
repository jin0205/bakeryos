---
name: gemini-prompt
description: Background knowledge for writing Gemini AI prompts consistent with BakeryOS conventions — unit normalization, Baker's percentages, structured JSON output, model selection, and error handling. Claude invokes this automatically when editing geminiService.ts or adding new AI features.
